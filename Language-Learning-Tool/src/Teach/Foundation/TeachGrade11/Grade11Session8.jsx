    ...
    <div className="grade-container">
      <div className="main-content1">
        <div className="header1">
          <h2>Grade 11 | Grammer | Level 8</h2>
        </div>
        <div className="content-grid">
          <div className="content-item">
            <h3>Verb Forms</h3>
            <div className="content-item-content">
              <img src={classroomTeachingImg} alt="Verb Forms" />
              <ul>
                <li
          ...
          <div className="content-item">
            <h3>Modals - Primary and Auxiliary</h3>
            <div className="content-item-content">
              <img src={storyTellingImg} alt="Modals - Primary and Auxiliary" />
              <ul>
                <li
                  onClick={handleCbtClick}
                  style={{
          ...
          <div className="content-item">
            <h3>Concord</h3>
            <div className="content-item-content">
              <img src={practiceSessionImg} alt="Concord" />
              <ul>
                <li
                  onClick={handleCbtClick}
                  style={{
          ...
          <div className="content-item">
            <h3>Imperatives</h3>
            <div className="content-item-content">
              <img src={additionalImg1} alt="Imperatives" />
              <ul>
                <li
                  onClick={handleCbtClick}
                  style={{
          ...
          <div className="content-item">
            <h3>Active to Passive</h3>
            <div className="content-item-content">
              <img src={additionalImg3} alt="Active to Passive" />
              <ul>
                <li
                  onClick={handleCbtClick}
                  style={{
          ...
          <div className="content-item">
            <h3>Clauses and Their Kinds</h3>
            <div className="content-item-content">
              <img src={additionalImg4} alt="Clauses and Their Kinds" />
              <ul>
                <li
                  onClick={handleCbtClick}
                  style={{
